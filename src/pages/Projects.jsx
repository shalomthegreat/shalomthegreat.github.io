...
const categories = ['All', 'Web', 'Desktop', 'Android']
...
function ProjectCard({ p, index }) {
  ...
  return (
    <motion.div
      ...
      className="card group relative flex h-full flex-col overflow-hidden p-6 hover:-translate-y-1 hover:border-accent/50 hover:shadow-glow"
    >
      {p.featured && (
        <span className="absolute right-4 top-4 rounded-full bg-accent/10 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-accent">
          Featured
        </span>
      )}
